...
> Синхронизация общей мастер-онтологии (`DS-ecosystem-development/ontology.md`) с Pack-онтологиями и Downstream.
...
| Общая мастер-онтология (DS-ecosystem-development/ontology.md) | Найти расхождения | Предложение обновлений |
