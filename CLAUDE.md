...
6. **Владелец онтологии — Экстрактор:** Онтологию (`01C-ontology.md`) на любом уровне изменяет **только** Knowledge Extractor. Пользователь предлагает изменения; Экстрактор формализует, валидирует привязку к SPF-понятиям и применяет
