...
Каждое доменное понятие Pack'а обязано иметь родительское понятие из базовой онтологии SPF. Прочитай `SPF/spec/SPF.SPEC.002-ontology.md` секция 2 — найди подходящее U.* понятие. Например: «цифровая платформа» → U.System, «экстракция знаний» → U.Method, «индикатор» → U.Characteristic.
...
3. **Прочитай** `01C-ontology.md` целевого Pack'а (SPF.SPEC.002) — согласованы ли типы и термины кандидата с онтологией.
...
| **Расширяет онтологию** | Вводит новый тип, термин или связь | Добавить отдельный кандидат на обновление `01C-ontology.md` |
...
- [ ] Онтология: типы и термины согласованы с `01C-ontology.md`?
...
- Онтологию (`01C-ontology.md`) изменяет **только** Экстрактор — пользователь предлагает, Экстрактор формализует
