...
4. **Привяжи к родительскому понятию SPF.** Прочитай `SPF/spec/SPF.SPEC.002-ontology.md` секция 2 — найди подходящее U.* понятие. Укажи «FPF-понятие» или «Родительское понятие (SPF)».
...
3. **Прочитай** `01C-ontology.md` целевого Pack'а (SPF.SPEC.002) — согласованы ли типы и термины.
...
| **Расширяет онтологию** | Вводит новый тип/термин | Добавить кандидат на обновление `01C-ontology.md` |
