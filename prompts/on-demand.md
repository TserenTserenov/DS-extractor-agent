...
4. **Привяжи к родительскому понятию SPF.** Прочитай `SPF/spec/SPF.SPEC.002-ontology.md` секция 2 — найди подходящее U.* понятие. Например: «цифровая платформа» → U.System. Укажи «FPF-понятие» или «Родительское понятие (SPF)».
...
| **Расширяет онтологию** | Вводит новый тип/термин | Предложить обновление `01C-ontology.md` |
